...
| 07 | Wähler-Sturm | **p5.js · interaktiv** | Bundesland + Partei wählen: deine Partei = heller Kern, andere Parteien = Sphären drumherum, Größe ∝ echte Zweitstimmen. Live-Regler (Menschen/Partikel, Sphären-Abstand/-Größe). `?land=Bayern&partei=CSU` springt direkt in den Sturm. |
