...
| 07 | Wähler-Sturm | **p5.js · interaktiv** | Start: neutrale graue Sphäre (alle Stimmen). Dropdowns oben links (Bundesland → Partei) transformieren live: Bundesland = stärkste Partei als Kern + andere als Sphären; Partei = deine Partei als Kern. Felder leeren → wieder neutral. Größe ∝ echte Zweitstimmen. Live-Regler. `?land=&partei=` als Direkt-Hook. |
